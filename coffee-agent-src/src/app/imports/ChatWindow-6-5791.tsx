import svgPaths from "./svg-99d3w57n4m";
...
function Paragraph3() {
  return (
    <div className="h-[40px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#041c33] text-[14px] top-[0.5px] w-[259px]">Hey Alex! Ready to meet someone new from Product Design next week?</p>
    </div>
  );
}
...
function Paragraph5() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#041c33] text-[14px] text-nowrap top-[0.5px] whitespace-pre">Great! How would you prefer to meet?</p>
    </div>
  );
}
...
function ChatMessage2() {
  return (
    <div className="bg-[#f6f8fa] h-[46px] relative rounded-[8px] shrink-0 w-[285.266px]" data-name="ChatMessage">
      <div aria-hidden="true" className="absolute border border-[#d5dbe1] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex flex-col h-[46px] items-start pb-px pt-[13px] px-[17px] relative w-[285.266px]">
        <Paragraph5 />
      </div>
    </div>
  );
...
function Container8() {
  return (
    <div className="absolute content-stretch flex gap-[12px] h-[46px] items-start left-0 top-[142px] w-[364px]" data-name="Container">
      <Container7 />
      <ChatMessage2 />
    </div>
  );
...
function Paragraph6() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[14px] text-nowrap text-white top-[0.5px] whitespace-pre">Online</p>
    </div>
  );
}
...
function ChatMessage3() {
  return (
    <div className="absolute bg-[#635bff] box-border content-stretch flex flex-col h-[44px] items-start left-[290.16px] pb-0 pt-[12px] px-[16px] rounded-[8px] top-[204px] w-[73.844px]" data-name="ChatMessage">
      <Paragraph6 />
    </div>
  );
}
...
function Paragraph7() {
  return (
    <div className="h-[40px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#041c33] text-[14px] top-[0.5px] w-[240px]">{`Perfect! I found someone who's also available for an online chat.`}</p>
    </div>
  );
}
...
function Container10() {
  return (
    <div className="absolute content-stretch flex gap-[12px] h-[66px] items-start left-0 top-[264px] w-[364px]" data-name="Container">
      <Container9 />
      <ChatMessage4 />
    </div>
  );
...
function Container20() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] h-[829px] items-start left-[22px] top-[91px] w-[364px]" data-name="Container">
      <Container4 />
      <Container11 />
      <Container14 />
      <Container18 />
